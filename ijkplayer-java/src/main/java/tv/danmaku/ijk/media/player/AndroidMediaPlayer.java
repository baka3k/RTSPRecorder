...
public class AndroidMediaPlayer extends AbstractMediaPlayer {
    ...
    public int startRecord(String file) {
        Log.w("AndroidMediaPlayer","#startRecord err: Android mediplayer has no record function");
        return 0;
    }

    @Override
    public int stopRecord() {
        Log.w("AndroidMediaPlayer","#stopRecord err: Android mediplayer has no record function");
        return 0;
    }
